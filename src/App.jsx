      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden w-full relative">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-4 md:p-6 relative">
          <Routes>
            ...
            {/* Lainnya (Placeholder) */}
            <Route path="/topology" element={<PlaceholderPage title="Topologi Jaringan" />} />
            <Route path="/settings" element={<PlaceholderPage title="Pengaturan Aplikasi" />} />

            {/* Fallback 404 */}
            <Route path="*" element={<div className="p-10 text-center text-gray-500">Halaman tidak ditemukan (404)</div>} />
          </Routes>
        </main>
